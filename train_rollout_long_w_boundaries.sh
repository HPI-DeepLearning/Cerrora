...
OUTPUT_DIR="/sc/projects/sci-aisc/ekapex/trained_models_on_cerra_jona/Aurora_large_6h_rollout_long_w_boundaries"
...
python -m torch.distributed.run --nnodes=1 --nproc_per_node=8 --master_port=25794 main.py \
    ...
    logging.project_name=Aurora_large_6h_rollout_long_w_boundaries \
